...
$F$-statistic of \citet{montielolea2013robust} in this just-identified setting.
...
proposed by \citet{staigerstock1997instrumental}.
...
% ---------- Tables ----------
\input{sum/ioc_days_dwnstrm}\clearpage
\input{sum/visit_type_summary}\clearpage
\input{sum/mr_mcl_incidence_summary}\clearpage
\input{sum/6yr_huc02fe_inorg_val_sumstats_ravalli_2005}\clearpage
\input{sum/syr2_mr_comparison}\clearpage
\input{sum/upstream_coal_summary}\clearpage
\input{reg/fs_dwnstrm_minevio_ivsum.tex}\clearpage
...
\input{reg/mr_concentration_lag}\clearpage
\input{reg/mr_concentration_lag_national_downstream_states}\clearpage
\input{sum/sanitary_visit_timing_formal_enforcement_rate}\clearpage
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{plots/mineviolengthhist_downstream.png}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{plots/map_huc12_main_sample.png}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{plots/sulfur_histogram_downstream2sls.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth]{plots/proportionatecircleprod_diff_allminehuc12_1985_2005.png}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth]{plots/proportionatecircle_upstream_mines_huc12_1985_2005.png}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{plots/scatterhuccoalsulfur_pooled.png}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{plots/first_stage_scatter_dwnstrm.png}
