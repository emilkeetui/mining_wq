...
\begin{document}
	...
	\textit{Step 3: the self-report cutoff scales by $\lambda$.} The self-report condition with the scaled penalties, $c + \lambda r\,q(a) \le \lambda\big[t+ps\,q(a)\big]$ rearranges to
