...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Separation of utility choices over contamination help identify the effect of contamination.
    \end{itemize}
...
\begin{itemize}\small
    \item $\uparrow$ mining $\rightarrow$ $\uparrow$ contaminant concentrations, but never above the MCL. 10M cumulative tons upstream raises mean nitrate by 12.9\% of its sample mean (***) and selenium by 8.5\% (**); arsenic and barium show no significant change.
    ...
    \item formal enforcement: $-$1.8 pp against a base rate of 3\% but imprecisely measured.
...
\begin{itemize}\small
    \item Choose negligence $a$, unobserved by regulator, with benefit $\theta b(a)$, opportunity cost relative to a maximum negligence $\theta b(\bar{a})$.
...
\begin{itemize}
    ...
    \item The utility chooses $a$ to minimize $-\theta[b(\bar{a})-b(a)] - e(a; c)$.
...
\begin{itemize}\small
    ...
    \item Average distance between centroid of adjacent HUC12's is 11 km.
...
\takeaway{Nitrate $+$0.10 mg/L per 10M tons (***): 12.9\% of its mean. Selenium $+$0.0004 mg/L (**): 8.5\% of its mean. \textbf{Every reading in the sample stays under its MCL.} \backuplink{kgridsyr2}{effect across choice of upstream watershed radius}}
\end{frame}
...
\begin{frame}{The Acid Rain Program (``ARP") moved coal, not for water quality}
\begin{columns}[T]
...
\begin{itemize}\small
    \item \textbf{Independence.} The ARP is a national clean-air law set by national energy and emissions politics, not downstream utility's water quality.
...
\takeaway{Descriptive, not causal --- read the sign not magnitude. Utilities under-report when self-reporting gets expensive, not concealing.}
\end{frame}
...
\begin{itemize}\small
    ...
    \item Regulators inspection visits rise significantly --- substituting utility under-reporting.
