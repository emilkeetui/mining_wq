...
% N MR:    1,273 unique IOC MR violations, 1985--2005
% N MCL:   16 unique IOC MCL violations, 1985--2005
% ============================================================
...
\addlinespace[2pt]
03 & Monitoring, Regular & 1,260 & 99.0 \\
04 & Monitoring, Check/Repeat/Confirmation & 13 & 1.0 \\
\addlinespace[2pt]
\hline
 & \textit{Total} & 1,273 & 100.0 \\
\hline\hline
\end{tabular}
\vspace{8pt}
...
\hline
\addlinespace[2pt]
01 & Maximum Contaminant Level Violation, Single Sa.. & 11 & 68.8 \\
02 & Maximum Contaminant Level Violation, Average & 5 & 31.2 \\
\addlinespace[2pt]
\hline
 & \textit{Total} & 16 & 100.0 \\
\hline\hline
\end{tabular}
\vspace{8pt}
...
\hline
\addlinespace[2pt]
333 & Inorganic Chemicals & 871 & 68.4 & 12 & 75.0 \\
331 & Nitrate Rule & 300 & 23.6 & 2 & 12.5 \\
332 & Arsenic Rule & 102 & 8.0 & 2 & 12.5 \\
\addlinespace[2pt]
\hline
  & \textit{Total} & 1,273 & 100.0 & 16 & 100.0 \\
\hline\hline
\end{tabular}
\begin{minipage}{\linewidth}
\vspace{4pt}
\footnotesize
\textit{Notes:} Panel A: violation codes classify the type of monitoring-and-reporting failure; code 03 = Monitoring, Regular; 04 = Monitoring, Check/Repeat/Confirmation. Panel B: violation codes classify the type of MCL exceedance. Panel C: rule 331 = Nitrate; 332 = Arsenic; 333 = Inorganic Chemicals; MR = monitoring and reporting violation; MCL = maximum contaminant level violation; inorganic chemicals (333) encompasses nitrates and arsenic as sub-contaminants. All panels restricted to IOC rules (nitrate 331, arsenic 332, inorganic chemicals 333). Sample restricted to the downstream 2SLS CWS-year sample (minehuc\_downstream\_of\_mine\,=\,1 and minehuc\_mine\,=\,0, 1985--2005, excluding PWSID WV3303401). Source: SDWA\_VIOLATIONS\_ENFORCEMENT.parquet, SDWA\_REF\_CODE\_VALUES.csv.
\end{minipage}
\end{table}
