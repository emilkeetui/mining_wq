...
% N concurrent:  mining=523, nonmining=741
% N following:   mining=506, nonmining=678
% ============================================================
...
\multicolumn{3}{l}{\quad\textit{(N\,=\,523 mining; N\,=\,741 non-mining PWSID$\times$rule$\times$year cells)}} \\
\addlinespace[2pt]
MR only --- no concurrent MCL or TT (\%) & 99.2 & 93.3 \\
MCL concurrent with MR (\%) & 0.8 & 5.1 \\
TT concurrent with MR, no MCL (\%) & 0.0 & 1.6 \\
\addlinespace[6pt]
\multicolumn{3}{l}{\textit{Panel B: Following year --- same PWSID, same contaminant, year\,$+$\,1}} \\
\multicolumn{3}{l}{\quad\textit{(index violations in 1985--2004; N\,=\,506 mining; N\,=\,678 non-mining)}} \\
\addlinespace[2pt]
No violation recorded (\%) & 94.1 & 74.6 \\
MR only --- monitoring failure again, no MCL (\%) & 5.9 & 20.8 \\
MCL violation (with or without MR) (\%) & 0.0 & 3.2 \\
TT only --- no MR or MCL (\%) & 0.0 & 1.3 \\
\hline\hline
\end{tabular}
