...
build_table <- function(rows, n1, n2) {
  ...
  footer <- paste0(
    "\\hline\n",
    "\\multicolumn{5}{l}{\\textit{N} CWSs: group 1 = ", n1, ", group 2 = ", n2, "} \\\\\n",
    "\\multicolumn{5}{l}{\\footnotesize Sample: CWSs in the strictly downstream 2SLS sample ",
    "(downstream HUC, not colocated with a mine).} \\\\\n",
    "\\multicolumn{5}{l}{\\footnotesize \\textit{Has SYR2 reading}: $\\geq 1$ Six-Year Review contaminant reading ",
    "for arsenic, nitrate, selenium, chromium, or barium.} \\\\\n",
    "\\multicolumn{5}{l}{\\footnotesize \\textit{No SYR2 reading}: CWS is in a state where $\\geq 1$ CWS ",
    "has a SYR2 reading but the CWS itself does not.} \\\\\n",
    "\\multicolumn{5}{l}{\\footnotesize MR violations: any of arsenic, nitrate, or inorganic chemicals ",
    "monitoring/reporting violation (inorganic chemicals encompasses selenium, chromium, barium).} \\\\\n",
    "\\multicolumn{5}{l}{\\footnotesize MCL violations: any of arsenic, nitrate, or inorganic chemicals ",
    "maximum contaminant level violation.} \\\\\n",
    "\\multicolumn{5}{l}{\\footnotesize Mean annual violations: sum of MR and MCL violation indicators ",
    "across arsenic, nitrate, and inorganic chemicals categories (max 6 per CWS-year).} \\\\\n",
    "\\multicolumn{5}{l}{\\footnotesize Diff.~stars from two-sample $t$-test: ",
    "*** $p{<}0.01$, ** $p{<}0.05$, * $p{<}0.1$.} \\\\\n",
    "\\hline\\hline\n",
    "\\end{tabular}\n",
    "\\end{adjustbox}\n",
